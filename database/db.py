...
class MindClockDb:
	...
	def init_db(self):
		...
		#operation
		operationssql="CREATE TABLE IF NOT EXISTS  table operations( id int, user_id int, replicate int, production_time int, reproduction_time int, early_time int, delay_time, type char)"
